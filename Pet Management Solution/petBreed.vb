Public Class petBreed
    ...
    Public Property Type As petType
        ...
        Set(value As petType)
            If executeUpdatelog(strAuditlog, "Pet Breed Form", "breed name", "pet", typeID, petType.Name, value.Name) Then
                petType = value
            End If
        End Set
    End Property
    ...
    Public Property Name As String
        ...
        End Get
        Set(value As String)
            If executeUpdatelog(strAuditlog, "Pet Breed Form", "breed name", "breed", breedID, breedname, value) Then
                breedname = value
            End If
        End Set
    End Property
